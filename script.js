(async () => {
  // Load Firebase config securely from GitHub Secrets (created at deploy)
  ...
  console.log("✅ Firebase initialized from GitHub Secrets");
  ...
  db.collection("foods").orderBy("created", "desc").onSnapshot(snapshot => {
    ...
    snapshot.forEach(doc => {
      ...
      // Comments
      card.querySelector(".comment-input button").addEventListener("click", async () => {
